...
function showLogoutURL ()
{
	...
	if ($dirname != '/')
		$dirname .= '/';
	printf ('http%s://%s%sindex.php?logout', $https, $_SERVER['SERVER_NAME'], $dirname);
}
...
<div class="maintable">
 ...
 <?php echo getConfigVar ('enterprise') ?> RackTables <a href="http://tafe.com" title="Visit Tafe site"><?php echo CODE_VERSION ?></a><?php renderQuickLinks() ?>
 </div>
