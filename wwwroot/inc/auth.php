...
<p><a href=?login><b>Return to Tafe DC Assest Login Page</b></a></p>
<div>
</body></html>
ENDLOGOUTPAGE;
exit;
...
<IMG SRC="http://172.25.5.140/pix/tafe_trans.gif" ALIGN=”middle” HSPACE=”50” VSPACE=”50”/> 
<form action="${_SERVER['SCRIPT_NAME']}" method="POST">
$msg
<table>
<tr><td colspan=2 style="background-color: #df0a20;color: #f2ef3c;"><center><bold>Tafe DC Assest Login</bold></center></td></tr>
<tr><td><b>Username: </b></td><td><input type="text" name="username" autofocus="autofocus"></td></tr>
<tr><td><b>Password: </b></td><td><input type="password" name="password"></td></tr>
</table>
<p><center><input type="submit" value="Login"></center></p>
</div>
</body></html>
ENDLOGINFORM;
