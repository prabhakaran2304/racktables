...
$zabbix_password = 'zabbix'; // Password for selected user.
$zabbix_url = 'http://10.61.1.193/'; // You must specify only your domain name or IP address with http(s) prefix! Example: http://example.org
